...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intentFilter = new IntentFilter(ACTION_POWER_DISCONNECTED);
    ...
    private void showCharging(boolean charge) {
        if(charge) {
            mChargingImageView.setImageDrawable(
                    ContextCompat.getDrawable(this, R.drawable.ic_power_pink_80px));
        } else {
            mChargingImageView.setImageDrawable(
                    ContextCompat.getDrawable(this, R.drawable.ic_power_grey_80px));
        }
    }
    ...
    class ChargingBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            boolean isPowerConnected = intent.getAction().equals(ACTION_POWER_CONNECTED);
            showCharging(isPowerConnected);
        }
    }
}